...
public class POS {
	 ...
	 * @param args
	 */
	public static POS singleton = null;	
	public HashMap<String, String> userPasswdMap = new HashMap<String, String>();
	public String userPasswordFile = "userPasswordFile.txt";
	
	public HashMap<String, Item> itemList = new HashMap<String, Item>();
	public String itemListFile = "productListFile.txt";
	
	public String salesRecordFile = "logAndSales.txt";
	...
	public CurrencyFactory.Country country;
	public Currency currency;
	public Discount customerDiscount, eventDiscount;
	...
	public void getTaxModel(String s) {
		if (s.equals("NOTAX"))
	...
	public boolean setCurrency(CurrencyFactory.Country country) {
	...
	public void checkCurrency(String s) {
		if (s.equals("HK"))
	 ...
	 /** 
     * Round the input double value to specified decimal places with specified rounding mode. 
     * <p> 
     * For example: <br> 
     ...
     * @param scale 
     *            Decimal place to round to or the number of digits to the right of the decimal point. 
     * @param roundingMode 
     *            The specified rounding mode (more information can be found in JavaDoc of JDK: BigDecimal). 
     * @return The rounded result of the input value. 
     */  
